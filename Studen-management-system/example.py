from PyQt6.QtWidgets import QApplication, QVBoxLayout, QLabel, QWidget, QLayout, QLineEdit, QGridLayout, QPushButton

import sys
from datetime import datetime


class AgeCalulator(QWidget):
    def __init__(self):
        super().__init__()
        grid = QGridLayout()
